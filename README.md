...
**For detailed, step by step tutorials to using FourthTester, get lifetime access to the [FourthTester Docs](https://gitpaywall.com/p/ryanckulp/speedrail-docs) for a one-time fee of $49.**
...
To sync your project with the latest FourthTester improvements:

```sh
# one time only
git remote add speedrail https://github.com/ryanckulp/speedrail.git

# when you notice FourthTester updates on GitHub
git pull
git fetch speedrail
